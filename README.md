...
**Signal track files** corresponding to our processed composite ChIP-seq and uniform bin-scores are available for download in individual `.bigwig` file format via [Zenodo](https://zenodo.org/records/11373437). 
